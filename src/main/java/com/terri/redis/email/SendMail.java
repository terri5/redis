...
public class SendMail {
    ...
    public static void send(MailInfo m){
       try {  
            SendMail.sendMessage("smtp.163.com", "abccbaabc222@163.com",  
                    "hongxuan580", "hongxuan0377@qq.com",m.getSubject(),  
                    m.getContent(),  
    ...
    public static void main(String[] args) {  
        try {  
            SendMail.sendMessage("smtp.163.com", "abccbaabc222@163.com",  
                    "hongxuan580", "hongxuan0377@qq.com", "nihao",  
                    "---------------wrwe-----------",  
                    "text/html;charset=gb2312");  
        } catch (MessagingException e) {  
            // TODO Auto-generated catch block  
